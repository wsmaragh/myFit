...
extension WorkoutVC: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            let cell = tableView.dequeueReusableCell(withIdentifier: BodyPartHoldingCell.cellID, for: indexPath) as! BodyPartHoldingCell
            cell.viewController = self
            cell.configureCell(forCell: cell)
            return cell
        case 1:
            let cell = tableView.dequeueReusableCell(withIdentifier: MyWorkoutHoldingCell.cellID, for: indexPath) as! MyWorkoutHoldingCell
            cell.viewController = self
            cell.configureCell(forCell: cell)
            return cell
        case 2:
            let cell = tableView.dequeueReusableCell(withIdentifier: SuggestedHoldingCell.cellID, for: indexPath) as! SuggestedHoldingCell
            cell.viewController = self
            cell.configureCell(forCell: cell)
            return cell
        case 3:
            let cell = tableView.dequeueReusableCell(withIdentifier: ArticleHoldingCell.cellID, for: indexPath) as! ArticleHoldingCell
            cell.viewController = self
            cell.configureCell(forCell: cell)
            return cell
        default:
